                ...
                <div class="col-md-4 col-xl-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-body text-center">
                            <img
                                src="{{ asset('ui/backend/img/avatars/avatar-4.jpg') }}"
                                alt="Christina Mason"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            <div class="d-flex align-items-start">
                                <img
                                    src="{{ asset('ui/backend/img/avatars/avatar-5.jpg') }}"
                                    width="36"
                                    height="36"
                            ...
                            <div class="d-flex align-items-start">
                                <img
                                    src="{{ asset('ui/backend/img/avatars/avatar.jpg') }}"
                                    width="36"
                                    height="36"
                                    class="rounded-circle me-2"
                                    alt="Charles Hall"
                            ...
                            <div class="d-flex align-items-start">
                                <img
                                    src="{{ asset('ui/backend/img/avatars/avatar-2.jpg') }}"
                                    width="36"
                                    height="36"
                                    class="rounded-circle me-2"
                                    alt="William Harris"
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="row g-0 mt-1">
                                        ...
                                        >
                                            <img 
                                                src="{{ asset('ui/backend/img/photos/unsplash-1.jpg') }}"
                                        ...
                                        >
                                            <img
                                                src="{{ asset('ui/backend/img/photos/unsplash-2.jpg') }}"
                                                class="img-fluid pe-2"
                                                alt="Unsplash"
                                            />
                                        </div>
